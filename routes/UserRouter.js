...
const {userAuth,userIslog} = require('../middleware/auth')
...
router.get('/profile',userAuth,productController.loadProfilepage);
router.post('/editProfile',profileUpload.single('profileImage'),productController.editProfile);
router.post('/changeEmail',productController.changeEmail);
router.post('/verifyEmail-OTP',productController.verifyChangeEmail);
